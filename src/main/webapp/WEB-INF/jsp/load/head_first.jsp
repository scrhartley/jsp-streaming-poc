...
<c:set var="AUTO_FLUSH" value="${false}" /> <%-- Hack for demo --%>
...
<html>
	<head>
	    ...
	    <script defer crossorigin src="https://unpkg.com/@tanstack/react-query@4.13.4/build/umd/index.production.js"></script>
	</head>

	<% out.flush(); %>

	<body>
	    <div class="heroBanner"><img src="/loading/super_hero.webp" /></div>
